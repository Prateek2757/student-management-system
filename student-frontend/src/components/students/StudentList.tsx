      ...
      <table className="min-w-full table-auto border-collapse text-sm md:text-base">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="text-left px-3 py-2 hidden md:table-cell">Age</th>
            <th className="text-left px-3 py-2 hidden md:table-cell">Enrolled</th>
        ...
        <tbody>
          {currentStudents.map((student) => (
            <tr key={student._id} className="border-b">
              ...
              {isAdmin && (
                <td className="px-3 py-3 text-right space-x-2 min-w-[100px]">
                  <button
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center p- rounded-md border border-red-300 hover:bg-red-100 transition"
